            ...
            <div class="header">
                ...
                <div class="search">
                    <div class="search-input-container">
                        <input type="text" class="search-bar" placeholder="Search tasks..." bind:value={$searchQuery} on:input={debouncedFilterTasks} on:keydown={ (e) => { if (e.key === "Enter")e.preventDefault(); }} >
